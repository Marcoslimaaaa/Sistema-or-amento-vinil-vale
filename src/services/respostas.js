...
export const PADRAO = [
  ...
  // {{prazo}}, não "20" fixo: o prazo é campo do orçamento (execDays) e varia.
  // Com o número fixo, um orçamento de 25 dias mandava 20 para o cliente.
  { atalho: "prazo", titulo: "Prazo de execução", texto: "{{nome}}, o prazo de execução é de {{prazo}} dias úteis após a medição detalhada. Assim que fecharmos, já entra na agenda." },
